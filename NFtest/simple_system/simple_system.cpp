...
void NFtest_ss::run()
{
	...
	//Calling this sim function is the easiest way to run a simulation.  The first parameter is the
	//number of seconds you want to run for, the second is the number of times you want to output
	//the results to the output file.  So in this example, we run for 500 seconds and output 500 times,
...
{
	//Here is your first glimpse at defining a reaction rule.  This is the simplest rule

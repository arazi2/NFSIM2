...
/*!
  ...
  an add on or manipulating a
+669, you should create a new namespace.
...
namespace NFcore
{
	...
	*/
	...
	class System
	{
		...
		public:
			...
			*/
			...
			void getLocalFunction(string funcName) const { cout<<"getLocalFunction not yet implemented."<<endl; std::exit(1);};
	...
	/*!
	    ...
	    implementing classes are declared in the file reaction.hh.
	    @author Michael Sneddon
	*/
	class ReactionClass
	{
		...
		public:
			...
			virtual int getDORreactantPosition() const { cerr<<"Trying to get DOR reactant Position from a reaction that is not of type DOR!"<<endl;
															cerr<<"this is an internal error, and so I will quit."<<endl; std::exit(1); return -1; };
